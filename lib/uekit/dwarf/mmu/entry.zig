...
pub const VTable = struct {
    read: ?*const fn (*anyopaque, usize, []const u8) anyerror!usize,
    write: ?*const fn (*anyopaque, usize, []u8) anyerror!usize,
...
pub inline fn read(self: *const Entry, offset: usize, buf: []const u8) !usize {
...
pub inline fn write(self: *const Entry, offset: usize, buf: []u8) !usize {
    if (offset + buf.len > self.size) return error.OutOfBounds;
